#!/usr/bin/python
# coding=utf-8
# Originally Written By:zeesho rajpoot
# Source : Python2"
# Donot Recode It. 
...
\033[1;91m➣ Github  : https://github.com/Shanirajoot
\033[1;91m➣ GANG    : ZEESHO
\033[1;91m➣ Youtube : ZEESHO
\033[1;97m-----------------------------------------------"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
